...
export type InteractionButtonStylesProps = VariantProps<
  typeof interactionButtonStyles
>;
export type HeadingStylesProps = VariantProps<typeof headingStyles>;
export type SeparatedItemStylesProps = VariantProps<typeof separatedItemStyles>;
export type BadgeStylesProps = VariantProps<typeof badgeStyles>;
export type PageContainerStylesProps = VariantProps<typeof pageContainerStyles>;
export type BreadcrumbStylesProps = VariantProps<typeof breadcrumbStyles>;
export type MainImageStylesProps = VariantProps<typeof mainImageStyles>;
export type InteractionContainerStylesProps = VariantProps<
  typeof interactionContainerStyles
>;
export type FooterNavItemStylesProps = VariantProps<typeof footerNavItemStyles>;
export type RecipeInfoItemStylesProps = VariantProps<
  typeof recipeInfoItemStyles
>;
export type ReviewListStylesProps = VariantProps<typeof reviewListStyles>;
export type AuthorContainerStylesProps = VariantProps<
  typeof authorContainerStyles
>;
export type IngredientListStylesProps = VariantProps<
  typeof ingredientListStyles
>;
export type TagsContainerStylesProps = VariantProps<typeof tagsContainerStyles>;
